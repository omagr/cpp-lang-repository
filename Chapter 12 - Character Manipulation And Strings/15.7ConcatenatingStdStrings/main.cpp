...
int main()
{
	...
	std::string str7{std::string{"Hello"} + std::string{"World"} };
	std::string str7{std::string{"Hello"} + "World" };
	// Turn one or both into a std::string object  and do the concatenation
	...
	// Treats 67 as a character code When using the += operator, C++ knows to treat the integer operand as a character code and append that to our
