...
int main()
{
    ...
    //@ Concatenation
    std::cout << std::endl << "std::strcat : " << std::endl;
    char dest[50] = "Hello "; //! large enogh to9 stor ehow many char we w ant
    char src[50] = "World!";
    ...
    //@ More concatenation
    std::cout << std::endl << "More std::strcat : " << std::endl;
    ...
    std::cout << std::endl << "std::strncpy:" << std::endl;
