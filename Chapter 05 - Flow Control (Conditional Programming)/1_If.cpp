...
// !condtion: thre are no null,undefined, like values there is only one thng the conidtion is process which is boilleans, because it is hight strict langugae so
